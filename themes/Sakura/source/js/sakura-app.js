...
$(function () {
  ...
  console.log('%c FlitSneak %c', 'background:#24272A; color:#ffffff', '', 'https://www.FlitSneak.com/')
  console.log('%c Github %c', 'background:#24272A; color:#ffffff', '', 'https://github.com/FlitSneak/blog')
})
